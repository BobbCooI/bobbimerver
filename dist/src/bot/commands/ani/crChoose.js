...
exports.default = new GenericCommand_1.default({
    ...
    description: `2/3 - Use this command to choose the anime from ${constants_1.prefix}crSearch. Response should be the ordinal corresponding to the choices.`,
    slashCmd: true,
    slashOpts: {
        name: "crchoose",
    ...
    let emb = new discord_js_1.default.MessageEmbed()
        ...
        .addField(`Final step command: ${constants_1.prefix}crGetEp 2`, "This would fetch the 2nd episode of the anime.")
    ...
    if (choice.success === false)
        ...
        let emb = new discord_js_1.default.MessageEmbed()
            .setTitle(person.choiceTitle)
            .setDescription(`Success! The title ID is ${choice}`)
            .addField(`Final step command: /crGetEp 2`, "This would fetch the 2nd episode of the anime.")
            .setFooter("Make sure the selected anime episode of the season is correct!")
            .setTimestamp()
            .setColor(Math.floor(Math.random() * 0xffffff));
...
//# sourceMappingURL=crChoose.js.map